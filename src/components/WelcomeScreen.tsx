  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0a] text-white overflow-hidden flex flex-col">
      ...
      <header className="pt-4 px-4 text-center flex-shrink-0 z-10">
        ...
        <p className="text-gray-400 text-xs md:text-sm">让我们先了解你的身体数据</p>
      </header>
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-4 px-4 py-4 min-h-0 z-10">
        ...
        <div className="w-full lg:w-1/2 max-w-md mx-auto flex-shrink-0">
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 border border-white/10 shadow-xl">
            ...
            <div className="mb-4 md:mb-6 text-center lg:text-left">
              <h2 className="text-lg md:text-xl font-bold mb-1">{currentStep.title}</h2>
              <p className="text-gray-400 text-xs">{currentStep.description}</p>
            </div>
            ...
            <div className="mb-4 md:mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2 md:py-3 text-xl md:text-2xl font-bold text-center focus:outline-none focus:border-purple-500 transition-colors"
                />
                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 text-sm md:text-base">
                  {currentStep.unit}
                </span>
              </div>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4 md:mb-6 p-3 bg-white/5 rounded-xl">
              <div className="text-center">
                <div className="text-[10px] text-gray-400 mb-0.5">BMI</div>
                <div className="text-sm md:text-base font-bold">{bmi}</div>
              </div>
              <div className="text-center border-x border-white/10">
                <div className="text-[10px] text-gray-400 mb-0.5">体脂率</div>
                <div className="text-sm md:text-base font-bold">{bodyFatPct}%</div>
              </div>
              <div className="text-center">
                <div className="text-[10px] text-gray-400 mb-0.5">肌肉率</div>
                <div className="text-sm md:text-base font-bold">{musclePct}%</div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={handleSkip}
                className="flex-1 py-2 md:py-2.5 px-4 rounded-xl text-sm bg-white/5 hover:bg-white/10 transition-colors"
              >
                跳过
              </button>
              <button
                ...
                className="flex-1 py-2 md:py-2.5 px-4 rounded-xl text-sm bg-purple-500 hover:bg-purple-600 disabled:bg-white/10 disabled:text-gray-500 transition-colors font-semibold"
              >
                {step < 3 ? '下一步' : '开始训练'}
              </button>
            </div>
